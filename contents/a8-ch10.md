...
Here's your chance to combine everything into a multi-page app that:
...
You've built your first full-stack app: multiple routes, shared templates, form handling, and a dynamic list that grows as users submit entries.