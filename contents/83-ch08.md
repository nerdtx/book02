...
Without a `WHERE` clause, `DELETE` will remove all rows. Use it with caution!

---

Those four commands (`CREATE TABLE`, `INSERT INTO`, `SELECT`, `DELETE`) are what everything else you’ll do with SQL.
