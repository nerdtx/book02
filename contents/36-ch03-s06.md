...
**Input validation** is about combining conditionals and loops to solve a common real-world
problem. Input validation means checking whether the user gave you the kind of data you
